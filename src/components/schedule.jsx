        ...
        <div className="rounded-[25px] border border-white overflow-hidden w-full bg-[#28242c]">
          <div className="flow-root  mx-auto ">
            <div className="-my-4  divide-gray-200 ">
              ...
              <div className="flex gap-4 sm:gap-10 font-opensans">
                <div className="flex flex-col gap-2 w-40 bg-[#8C7D6B] py-4">
                  <p className="text-white text-center shrink-0">
                    12:00 - 12:45
                  </p>
                </div>
                <p className="text-white flex text-left items-center pl-2">
              ...
              <div className="flex gap-4 sm:gap-10 font-opensans">
                ...
                <p className="text-white flex justify-start items-center md:col-span-3 col-span-4 pl-3">
              ...
              <div className="border-b border-white w-full"></div>
              <div className="flex gap-4 sm:gap-10 pb-5 font-opensans">
                <div className="flex flex-col gap-2 w-40  py-4   md:col-span-2 col-span-4">
                  <p className="text-white text-center shrink-0">
                    17:05 - 17:35
                  </p>
          ...
          <div className="flow-root  mx-auto ">
            <div className="-my-4  divide-gray-200 ">
              ...
              <div className="flex gap-4 sm:gap-10 font-opensans">
                ...
                <p className="text-white   flex text-left items-center col-span-3">
              ...
              <div className="flex gap-4 sm:gap-10 font-opensans">
                ...
                <p className="text-white  flex text-left items-center md:col-span-3 col-span-4">
                  Introduction & Setup
                </p>
              </div>
              <div className="border-b border-white w-full"></div>
